export const texts = {
	en: {
		...
		step2: {
			header: 'Please confirm age of majority. Are you over the age of 18?'
		},
		step3: {
	...
	fr: {
		...
		step3: {
			header: 'Êtes-vous actuellement un membre GoodLife Fitness?'
		},
		step4: {
			formHeader:
		...
		step5: {
			womenHeader: 'Êtes-vous intéressé.e aux Clubs pour femmes seulement?',
			goals: {
			...
			complimentary:
				'Aimeriez-vous profiter d’un laissez-passer gratuit de 7 jours?'
		},
		step6: {
			header: 'Merci pour votre participation!',
			boldLine1:
				'Vous êtes maintenant inscrit.e pour une chance de gagner le grand prix de notre Événement Retrouvailles.',
			line2:
		...
		step7: {
			...
			wonHeader: 'Vous avez gagné une',
			claimHeader: 'Avant de partir!',
			claimSubheader: 'Avez-vous réclamé votre lot ?',
			claimText:
				'Assurez-vous d’obtenir votre lot instantané auprès d’un ambassadeur GoodLife sur place.',
			claimButton: 'J’ai réclamé mon lot'
		}
	}
}
